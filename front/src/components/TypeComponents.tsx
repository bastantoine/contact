...
export function ListComponent(props: {
    ...
    if (props.value) {
        ...
        return (
            <>
                {props.value
                    .map<React.ReactNode>((val, i) => (
                        <ComponentToUse value={val} key={i}></ComponentToUse>
                    ))
...
export const ATTRIBUTE_TYPE_COMPONENT_MAPPING: {[k: string]: any} =
    Object.assign({}, _ATTRIBUTE_TYPE_COMPONENT_MAPPING);
...
export const FILE_FIELDS = ["image"];
