        ...
        for (let attribute of this.props.config.attributes) {
            if (attribute !== this.props.config.primary_key) {
                ...
                if (attribute_type === "list") {
                    if (
                        typeof this.props.initial_value[attribute] === "string"
                    ) {
                        this.props.initial_value[attribute] = [
                            this.props.initial_value[attribute],
                        ];
                    ...
                    this.props.initial_value[attribute] =
                        this.props.initial_value[attribute].join(", ");
                }
                ...
                >
                    ...
                    {({
                        ...
                        <Form onSubmit={handleSubmit} noValidate>
                            {this.props.config.attributes.map(
                                (attribute: string) => {
                                    if (
                                        attribute !==
                                        this.props.config.primary_key
                                    ) {
                                        return (
                                            <ContactFormField
                                                attribute_config={
                                                    this.props.config
                                                        .raw_config[attribute]
                                                }
                                                attribute={attribute}
